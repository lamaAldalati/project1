...
<body>
    ...
    <div class="main-content">
        ...
        <div class="form-container">
            ...
            <form action="{{ route('patients.update', $appointment->id) }}" method="POST">
                @csrf
                @method('PUT')

                <label for="first_name">First Name:</label>
                <input type="text" id="first_name" name="first_name" value="{{ $appointment->first_name }}" required>

                <label for="last_name">Last Name:</label>
                <input type="text" id="last_name" name="last_name" value="{{ $appointment->last_name }}" required>

                <label for="address">Address:</label>
                <input type="text" id="address" name="address" value="{{ $appointment->address }}" required>
